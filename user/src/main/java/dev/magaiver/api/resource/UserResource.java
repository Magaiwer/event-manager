package dev.magaiver.api.resource;

import dev.magaiver.api.model.filter.UserEmailFilter;
import dev.magaiver.api.model.input.UserInput;
import dev.magaiver.api.model.input.UserPasswordInput;
import dev.magaiver.api.model.output.UserOutput;
import dev.magaiver.domain.model.User;
import dev.magaiver.domain.service.UserService;
